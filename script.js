...
(function () {
  ...
  if (themeToggle) {
    themeToggle.addEventListener("click", () => {
      ...
      document
        .querySelector('meta[name="theme-color"]')
        .setAttribute("content", isLight ? "#ffffff" : "#0a0a0a");
    });
  }
...
(() => {
  ...
  const fillA = new THREE.DirectionalLight(0xffffff, 0.7);
  fillA.position.set(-4, 3, -3);
  const fillB = new THREE.DirectionalLight(0xffffff, 0.6);
  fillB.position.set(0, -3, 2);
